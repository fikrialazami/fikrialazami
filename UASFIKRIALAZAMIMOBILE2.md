...
class App04 memperluas StatelessWidget {
  Pembuatan widget (konteks BuildContext) {
    kembalikan MaterialApp(
      rute: {
        "Data": (konteks) => FikrialazamiDataTable(),
      ...
      rumah: Perancah (
        appBar: AppBar(
          judul: Teks('UAS- FikriAlazami (6SIA5)'),
        ),
        isi: Halaman Masuk(),
      ),
    );
...
class NoelCristofer DataTable memperluas StatefulWidget {
  _NoelCristoferDataTableState createState() => _FikrialazamiDataTableState();
}

class _DavitSiburianDataTableState memperluas State<DavitSiburianDataTable> {
  ...
  Pembuatan widget (konteks BuildContext) {
    kembali Perancah (
      appBar: AppBar(
        judul: Teks('NoelCristofer - 6SIA4'),
      ),
...
kelas DataMahasiswa {
  ...
  static Daftar<DataMahasiswa> getDataBarang() {
    kembalikan <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Fikrialazami", ),
      DataMahasiswa(
          id: "Jenis Kelamin", namabarang: "laki laki", ),
      DataMahasiswa(id: "Alamat", namabarang: "Medan", ),
      DataMahasiswa(
